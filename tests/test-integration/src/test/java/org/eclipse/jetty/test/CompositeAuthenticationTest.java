...
import org.eclipse.jetty.security.CompositeAuthenticator;
...
public class CompositeAuthenticationTest
{
    ...
    public void before() throws Exception
    {
        ...
        CompositeAuthenticator compositeAuthenticator = new CompositeAuthenticator();
        ...
        compositeAuthenticator.addAuthenticator("/login/openid", openIdAuthenticator);
        ...
        compositeAuthenticator.addAuthenticator("/login/form", formAuthenticator);

        securityHandler.setAuthenticator(compositeAuthenticator);
